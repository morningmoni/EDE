...
from transformers_local import SingleSentenceClassificationProcessor as Processor
from transformers_local import TextClassificationPipeline, is_tf_available, is_torch_available
