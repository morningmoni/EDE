...
from transformers_local import is_torch_available
from transformers_local.file_utils import cached_property
from transformers_local.testing_utils import require_torch


if is_torch_available():
    import torch

    from transformers_local import MarianConfig, MarianMTModel
