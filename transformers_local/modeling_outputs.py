...
class Seq2SeqLMOutput(ModelOutput):
    ...
    encoder_hidden_states: Optional[Tuple[torch.FloatTensor]] = None
    encoder_attentions: Optional[Tuple[torch.FloatTensor]] = None
    attn_scores: Tuple = None
    keyword_logits: Optional[torch.FloatTensor] = None
    keyword_loss: Optional[torch.FloatTensor] = None
    constraint_logits: Optional[torch.FloatTensor] = None
