...
from utils.utils import est_time
    ...
    def output(self, step, num_steps, learning_rate, start):
        ...
        logger.info(
            ...
            % (step, num_steps,
               ...
               time.time() - start))
        sys.stdout.flush()
        # TODO hard coded start_step
        logger.info(est_time(cur_step=step, cur_time=time.time() - start, start_step=30000, end_step=num_steps))
